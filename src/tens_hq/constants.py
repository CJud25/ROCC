"""Stable configuration for the deterministic ROCC demonstration."""
...
DEFAULT_TARGET = 0.75
POLICY_FLOOR = 0.745
PLANNING_BUFFER = 0.03

SYNTHETIC_BANNER = "SYNTHETIC DEMO DATA — NOT FOR EMPLOYMENT OR COMPLIANCE DECISIONS"
PLANNING_BANNER = "PLANNING INDICATOR — NOT AN OFFICIAL ODLH COMPLIANCE DETERMINATION"
DRAFT_BANNER = "DRAFT — HUMAN REVIEW REQUIRED BEFORE USE"

RISK_ORDER = ["Critical", "At Risk", "Watch", "Healthy"]
RISK_COLORS = {
    "Healthy": "#167D7F",
    "Watch": "#B7791F",
    "At Risk": "#C05640",
...
STAGE_START_PROBABILITY = {
    ...
    "Applied": 0.16,
    "Screened": 0.24,
    "Interview Scheduled": 0.32,
    "Interviewed": 0.42,
    "Offer Pending": 0.63,
    "Offered": 0.78,
    "Hired": 1.00,
    "Eligibility Review Pending": 1.00,
    "Eligibility Cleared": 1.00,
    "Not Selected": 0.00,
    "Withdrawn": 0.00,
    "Separated": 0.00,
}
